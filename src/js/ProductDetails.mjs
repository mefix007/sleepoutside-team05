...
export default class ProductDetails {
    ...
    async init() {
        //dataSource will be used to get details of the current product, 
        //findProductById will return a promise. use await or. then()to process it
        this.product = await this.dataSource.findProductById(this.productId);
        //the product details are neeeded before rendering the HTML
        this.renderProductDetails();
        //once the HTML is rendered, add listener to the Add cart button
